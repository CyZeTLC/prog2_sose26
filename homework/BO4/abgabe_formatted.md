...
**Link zur Repo/Fork:** [https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/](https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/)
...
**Quellcode:** [MiniJavaTokens.java auf GitHub](https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/blob/master/src/main/java/highlighting/presets/MiniJavaTokens.java)
...
**Quellcode:** [MiniJavaTokensTest.java auf GitHub](https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/blob/master/src/test/java/MiniJavaTokensTest.java)
...
**Quellcode:** [RegexHighlighter.java auf GitHub](https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/blob/master/src/main/java/highlighting/regex/RegexHighlighter.java)
...
In der äußeren Schleife werden alle Regions durchgeschaut und für jede Region geprüft, ob sich diese mit einer anderen Region überschneiden. Die Überschneidung wird durch die innere Schleife geprüft. Also kurz gesagt, jede Region wird einzeln mit jeder Region verglichen.
...
**Quellcode:** [RegexHighlighterTest.java auf GitHub](https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/blob/master/src/test/java/RegexHighlighterTest.java) *(wie oben ist das Given-When-Then Muster nicht auf GitHub)*
...
**Job für build:** `./gradlew classes` dabei ist classes dafür da, dass nur die Klassen gebaut werden & nicht die ganze Jar.
...
* **Link zur PR für die JavaMiniTokens:** [https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/pull/1](https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/pull/1)
* **Link zur PR für den RegexHighlighter:** [https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/pull/2](https://github.com/CyZeTLC/prog2_ybel_syntaxhighlighting/pull/2)

### Aufg 4.3)

Meine beiden PRs wurden von Leonardo Parrino reviewet und daraufhin von mir verbessert/geändert.
Mein Review habe ich dementsprechend auch für Leonardo geschrieben. Dieses viel recht kurz aus, da inhaltlich alles eigentlich gut war. Das einzige, was nicht ganz ideal war, war, dass er nur eine PR für alles hatte bzw. auch nur einen Branch für die MiniJavaTokens & den RegexHighlighter. Dieses habe ich ihm dementsprechend als Review direkt als erstet geschrieben. Darauf hin hat er es in einzelne Branches und zwei neue PRs aufgeteilt. Dieses hatte er dann auch direkt in den master gemerged, weshalb ein weiteres Review nicht mehr möglich war. Ich hatte ihn noch privat gefragt, ob er ein weiteres/neues Review haben möchte, aber das passte ihm soweit und er meinte das erste reiche (sehe ich theoretisch auch so) :)